...
photo-tools tag run /path/to/photos

# Dry run — preview tags without writing
photo-tools tag run /path/to/photos --dry-run

# Run specific pipelines only
photo-tools tag run /path/to/photos --ram          # content tags (RAM++)
photo-tools tag run /path/to/photos --ocr          # text detection (PaddleOCR)
photo-tools tag run /path/to/photos --landmarks    # landmark lookup (CLIP + FAISS)

# Re-tag — clears previous autogenerated tags first
photo-tools tag run /path/to/photos --force

# Wipe ALL keywords + photo-tools namespace before re-tagging (nuclear option)
photo-tools tag run /path/to/photos --clear-all

# Watch for new images and auto-tag them
photo-tools tag run /path/to/photos --watch
...
photo-tools tag fix /path/to/photos
photo-tools tag fix /path/to/photos --ocr      # only consider OCR
